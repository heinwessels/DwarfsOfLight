...
public:
    Entity(Vec2 posision) : m_position(posision) { }
    ...
    Vec2 get_posision() const { return m_position; }
    Vec2* get_position_ptr() { return &m_position; /* Use at own risk */ }
    void set_posision(Vec2 posision) { m_position = posision; }
